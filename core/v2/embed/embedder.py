...
from dpsutil.vector.distance import normalize_L2

from torchvision.transforms.functional import to_tensor

from core.v2.embed.insight_face import InsightFace, IR_50
...
#         device = 'cuda'
        ...
        write_info(f'Loaded face embedding from {model_path} with device {device}')
